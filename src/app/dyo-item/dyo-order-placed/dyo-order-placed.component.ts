...
@Component({
  selector: 'app-dyo-order-placed',
  templateUrl: './dyo-order-placed.component.html',
  styleUrls: ['./dyo-order-placed.component.less']
})
export class DyoOrderPlacedComponent implements OnInit {
