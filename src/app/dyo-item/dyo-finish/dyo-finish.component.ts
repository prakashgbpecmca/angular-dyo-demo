...
@Component({
  selector: 'app-dyo-finish',
  templateUrl: './dyo-finish.component.html',
  styleUrls: ['./dyo-finish.component.less']
})
export class DyoFinishComponent implements OnInit {
  ...
  constructor(private _router:Router,private modalService: BsModalService, private _dyoService:DyoService) {
    ...
    this.backImg='assets/shirt/Black_Back.png';
  }
